...
// This is a patched version of the types in DefinitelyTyped (search for 'mrozekma' below)
...
declare module "node-forge" {
	...
	namespace cipher {
		...
		interface StartOptions {
			...
			tagLength?: number;
			// mrozekma -- Added ByteBuffer. Original declaration file claims additionalData must be a string, but a buffer works fine and is saner
			additionalData?: string | util.ByteBuffer;
		}

		interface BlockCipher {
			start: (options?: StartOptions) => void;
			update: (payload: util.ByteBuffer) => void;
			// mrozekma -- Added 'pad' parameter. This parameter is deprecated and not exposed in the original declaration file
			finish: (pad?: (blockSize: number, buffer: util.ByteBuffer, decrypt: boolean) => boolean) => boolean;
